<div id="beyond" class="container">
    ...
    <div class="col-sm-12">
        ...
        <div class="jumbotron" style="font-size:18px;">
            ...
            <p class="p1"><span class="s1">It appears as though the assignment would accept photographs of the real objects. Half of these rockets don't actually exist yet, and won't until the late 2020's. I have chosen to render my rockets and photoshop them into outer space. I have created the Starhopper in orbit of the earth, the Starship exploring space, the Booster detaching from the starship, and the Falcon 9 returning to earth. I colour corrected the renders in order to fit convincingly in the compositions.&nbsp;</span></p>
